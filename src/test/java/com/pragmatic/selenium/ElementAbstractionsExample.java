 ...
 */
public class ElementAbstractionsExample {
    ...
    public void testAddEmployeeWithMandatoryInformationAndLoginCredentialsEnabled() throws InterruptedException {
        ...
        WebElement chkElement = driver.findElement(By.id("chkLogin"));
        CheckBox chkCreateLogin = new CheckBox(chkElement);
        chkCreateLogin.check();
    ...
    //TODO This should be moved to a public class
